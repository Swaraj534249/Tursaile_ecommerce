...
exports.create=async(req,res)=>{
    try {
        const created=new Rank(req.body)
        await created.save()
...
exports.getAll = async (req, res) => {
    try {
        ...
        const totalDocs=await Rank.find(filter).countDocuments().exec()
        const results=await Rank.find(filter).skip(skip).limit(limit).exec()
...
exports.getById=async(req,res)=>{
    try {
        const {id}=req.params
        const result=await Rank.findById(id)
...
exports.updateById=async(req,res)=>{
    try {
        const {id}=req.params
        const updated=await Rank.findByIdAndUpdate(id,req.body,{new:true})
...
exports.undeleteById=async(req,res)=>{
    try {
        const {id}=req.params
        const unDeleted=await Rank.findByIdAndUpdate(id,{isDeleted:false},{new:true})
...
exports.deleteById=async(req,res)=>{
    try {
        const {id}=req.params
        const deleted=await Rank.findByIdAndUpdate(id,{isDeleted:true},{new:true})
